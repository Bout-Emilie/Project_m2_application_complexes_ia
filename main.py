...
def main(argv):
    ...
    (train_x, train_y), (test_x, test_y) = poc.load_data()
    ...
    # Train the Model.
    classifier.train(
        input_fn=lambda:poc.train_input_fn(train_x, train_y,
                                                 args.batch_size),
    ...
    eval_result = classifier.evaluate(
        input_fn=lambda:poc.eval_input_fn(test_x, test_y,
                                                args.batch_size))
    ...
    predictions = classifier.predict(
        input_fn=lambda:poc.eval_input_fn(predict_x,
                                                labels=None,
    ...
    for pred_dict, expec in zip(predictions, expected):
        ...
        print(template.format(constantes.SPECIES[class_id],
